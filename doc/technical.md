...
Most of the part follows [Electron React Boilerplate](https://electron-react-boilerplate.js.org/).

- `./src` contains all the source code. It is divided into 3 main parts.
  - `./src/repos` contains all the main functions
  - `./src/views` contains all gui components
  - `./src/stores` contains the states and actions of ui, usually one per each page
  - `./src/main/bridge.ts` contains all custom ipc functions
- `./assets` contains all custom assets to be bundled
- `./.erb` contains all webpack build configs
